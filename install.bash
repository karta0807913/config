...
sudo apt install -y i3-gaps-wm i3blocks feh compton maim htop /tmp/chrome.deb gcc emacs27 font-manager playerctl polybar rofi python3-pip numlockx xclip polybar
